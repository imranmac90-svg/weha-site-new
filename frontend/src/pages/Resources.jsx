...
const resources = [
  ...
  },
  {
    ...
    icon: FileText,
    title: "Free eBooks",
    desc: "Deep-dive guides on compliance-grade AI automation for SMBs across the UAE, Australia and Singapore.",
    tag: "eBooks",
  },
];
...
export default function Resources() {
  return (
    <div data-testid="resources-page" className="overflow-x-hidden">
      <Seo
        title="Resources — free workbooks, automations & eBooks"
        description="Free WeHA resources: practical workbooks, ready-to-import workflow automations, and eBooks on compliance-grade AI automation for SMBs."
        path="/resources"
      />
      <PageHero
        kicker="Resources"
      ...
      <ScrollSection direction="right" settle depth={0.35} intensity={0.45}>
        <CTABanner
          ...
          sub="Book a free AI Audit and we'll map your top 3 automatable workflows — live."
